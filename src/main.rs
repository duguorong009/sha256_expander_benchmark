...
fn main() {
    ...
    // compile the circuit
    let compile_result = compile_cross_layer(&SHA256Circuit::default(), CompileOptions::default()).unwrap();
    ...
    let mut assignments: Vec<SHA256Circuit<GF2>> = vec![SHA256Circuit::default(); 1];
